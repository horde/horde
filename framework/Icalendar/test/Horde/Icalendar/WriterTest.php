...
DESCRIPTION:Lörem ipsüm dölör sit ämet\, cönsectetüer ädipiscing
  elit. Aliqüäm söllicitüdin fäücibüs mäüris ämet.
END:VEVENT
END:VCALENDAR
',
                            $ical->export());
...
UID:XXX
DTSTART;VALUE=DATE:20080101
DESCRIPTION;ENCODING=QUOTED-PRINTABLE;CHARSET=UTF-8:L=C3=B6rem ips=C3=BCm d=C3=B6l=C3=B6r sit =C3=A4met,=
...
UID:XXX
DTSTART;VALUE=DATE:20080101
DESCRIPTION;ENCODING=QUOTED-PRINTABLE;CHARSET=UTF-8:L=C3=B6remips=C3=BCmd=C3=B6l=C3=B6rsit=C3=A4met,c=C3=B6nsectet=C3=BCer=C3=A=
...
DESCRIPTION:SYLVIE DAGORNE a écrit :\n\nBonjour\,\n\nsuite à mon appel
  téléphonique auprès de Jacques Benzerara\, il m\'a renvoyé vers vous.
  En effet\, je souhaiterais vous rencontrer car:\n1°) au niveau de
  l\'observatoire local nous devons lancer une enquête sur un suivi de
  cohorte à la rentrée prochaine qui concernera tous les étudiants de
  L1. Nous souhaiterons faire un questionnaire en ligne ce questionnaire
  devra être hébergé sur un serveur.\n\n2°) dans le cadre de
  l\'observatoire régional\, nos partenaires nous demande également de
  faire des questionnaires en ligne. Nous disposons du logiciel Modalisa
  qui permet de le réaliser mais du point de vu technique\, nous avons
  besoin de voir avec vous\,  les difficultés et les limites d\'un tel
  dispositif afin de voir les démarches à suivre et pouvoir évoquer tous
  ces problèmes techniques\, je souhaiterais vous rencontrer. Merci de me
  précisez vos disponibilités?\n...\nJe serai accompagné d\'un collègue
  pour l\'observatoire local (David Le foll) et de la chargée d\'études de
