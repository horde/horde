...
class Horde_Core_ActiveSyncTests extends Horde_Test_Case
{
    ...
    {
        $connector = $this->getMockSkipConstructor('Horde_Core_ActiveSync_Connector');
        $connector->expects($this->once())->method('horde_listApis')->will($this->returnValue(array('mail')));
