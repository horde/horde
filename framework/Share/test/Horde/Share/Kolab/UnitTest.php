...
extends PHPUnit_Framework_TestCase
{
    ...
    public function testGetTypeString()
    {
        $driver = new Horde_Share_Kolab(
            'mnemo', 'john', new Horde_Perms_Sql(array('db' => true)), new Horde_Group_Test()
        );        
    ...
    {
        $driver = new Horde_Share_Kolab(
            'kronolith', 'john', new Horde_Perms_Sql(array('db' => true)), new Horde_Group_Test()
        );        
    ...
    {
        $driver = new Horde_Share_Kolab(
            'turba', 'john', new Horde_Perms_Sql(array('db' => true)), new Horde_Group_Test()
        );        
    ...
    {
        $driver = new Horde_Share_Kolab(
            'nag', 'john', new Horde_Perms_Sql(array('db' => true)), new Horde_Group_Test()
        );        
    ...
    {
        $driver = new Horde_Share_Kolab(
            'NOTSUPPORTED', 'john', new Horde_Perms_Sql(array('db' => true)), new Horde_Group_Test()
        );        
    }
    ...
    private function _getDriver($app = 'mnemo')
    {
        return new Horde_Share_Kolab(
            $app, 'john', new Horde_Perms_Sql(array('db' => true)), new Horde_Group_Test()
        );
    }
