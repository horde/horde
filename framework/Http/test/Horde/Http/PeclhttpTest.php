 ...
 * @license    http://www.horde.org/licenses/bsd
 */
class Horde_Http_PeclhttpTest extends Horde_Test_Case
{
    private $_server;
    ...
    {
        $client = new Horde_Http_Client(array('request' => new Horde_Http_Request_Peclhttp()));
    ...
    public function testThrowsOnInvalidProxyType()
    {
        $client = new Horde_Http_Client(
            array(
                'request' => new Horde_Http_Request_Peclhttp(
                    array(
