<div class="hermesMenu">
  <div id="hermesNavTime" class="horde-subnavi">
    <div class="horde-subnavi-icon">
      <a class="icon"></a>
    </div>
    <div class="horde-subnavi-point"><?php echo _("My Time") ?></div>
  </div>
  <div id="hermesNavSearch" class="horde-subnavi">
    <div class="horde-subnavi-icon">
      <a class="icon"></a>
    </div>
  ...
  <div id="hermesMenuTimers" class="horde-resources"></div>
</div>
