...
<?php endif ?>
<div<?php if (!empty($container['id']) && !is_int($container['id'])) echo ' id="' . $container['id'] . '"' ?> class="horde-sidebar-<?php if ($containerCounter == count($this->containers) - 1) echo 'sub' ?>folder">
