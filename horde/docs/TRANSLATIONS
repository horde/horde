...
This renders to "說明(H)" in the interface and you can access this link with
"H" as the access key.

Since Horde 6, translators of languages with a latin character system can
specify characters with diacritics as access keys. The base character will then
...
This renders to "Úkoly" with the Ú character underlined in the interface and
you can access this link with "U" as the access key.
