...
Development of the dynamic interface sponsored by Portugal Telecom's SAPO
division (http://softwarelivre.sapo.pt/).
...
=====================   ======================================================
Arabic (Oman)           Said Al-Hosni <admin@wabhosting.com>
Arabic (Syria)          Platinum Development Team <devteam@platinum-sy.net>
Basque                  Euskal Herriko Unibertsitatea <webmaster@ehu.eus>
Bosnian                 Alen Sarkinovic <alen@linux.org.ba>
                        Vedran Ljubovic <vljubovic@smartnet.ba>
Brazilian Portuguese    <hostmaster@sbs.srv.br>
...
French                  Christophe Ruelle <ruelle@echo.fr>
                        ...
                        Ronan Salmon <rsalmon@mbpgroup.com>
                        Paul De Vlieger
...
German                  Carsten Guenther <cguenther@guenthers.net>
                        Jan Schneider <jan@horde.org>
...
Norwegian Bokmaal       Øyvind Monsløp <omonslop@online.no>
                        Oystein Steimler <oystein@rexta.net>
...
Polish                  Mariusz Zynel <mariusz@math.uwb.edu.pl>
                        ...
                        Przemyslaw "Primo" Witek <primo@npl.pl>
