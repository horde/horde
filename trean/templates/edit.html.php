...
<table cellspacing="0">
 <tr>
  ...
  <td><input type="text" name="url" size="40" value="<?php echo htmlspecialchars($bookmark->url) ?>" /></td>
 </tr>

 <tr>
  <td align="right" width="1"><strong><?php echo _("Title") ?></strong></td>
  <td><input type="text" name="title" size="40" value="<?php echo htmlspecialchars($bookmark->title) ?>" /></td>
 </tr>

 <tr>
  <td align="right"><strong><?php echo _("Description") ?></strong></td>
  <td><input type="text" name="description" size="40" value="<?php echo htmlspecialchars($bookmark->description) ?>" /></td>
 </tr>
