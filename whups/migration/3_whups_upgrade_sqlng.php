...
class WhupsUpgradeSqlng extends Horde_Db_Migration_Base
{
    ...
    public function up()
    {
        $t = $this->createTable('whups_sharesng', array('autoincrementKey' => 'share_id'));
        ...
        $t = $this->createTable('whups_sharesng_groups', array('autoincrementKey' => false));
        ...
        $t = $this->createTable('whups_sharesng_users', array('autoincrementKey' => false));
        $t->column('share_id', 'integer', array('null' => false));
