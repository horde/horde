<?php
/**
 * This is the template for notification emails sent after creating a new
 * ticket.
 *
 * If you want to customize this template, copy it to
 * "create_email.plain.local.php" first, and edit that version.  You can also
 * specify queue-specific notification messages by creating seperate files with
 * the following naming convention: "create_email.plain.X.php" will be used for
 * ticket creation emails for queue "X".
 *
