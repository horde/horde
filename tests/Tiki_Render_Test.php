...
class Text_Wiki_Render_Tiki_SetUp_Tests extends PHPUnit_Framework_TestCase
{
    ...
    {
        $obj = Text_Wiki::singleton('Tiki');
        $className = 'Text_Wiki_Render_Tiki_' . $this->renderRule;
...
class Text_Wiki_Render_Tiki_Code_Test extends Text_Wiki_Render_Tiki_SetUp_Tests
{
    ...
    {
        $this->markTestIncomplete('Fix the code so the test below pass');
...
class Text_Wiki_Render_Tiki_List_Test extends Text_Wiki_Render_Tiki_SetUp_Tests
{
    ...
    public function testTikiRenderNumberListStart()
    {
    ...
    public function testTikiRenderBulletListStart()    
    {
    ...
    public function testTikiRenderListOtherTypes()
    {
        $otherTypes = array('bullet_item_end', 'number_item_end', 'bullet_list_start', 'number_list_start', 'bullet_list_end', 'number_list_end');
