...
class JonahUpgradeAutoIncrement extends Horde_Db_Migration_Base
{
    ...
    public function up()
    {
        $this->changeColumn('jonah_channels', 'channel_id', 'integer', array('null' => false, 'autoincrement' => true));
        $this->changeColumn('jonah_stories', 'story_id', 'integer', array('null' => false, 'autoincrement' => true));
        $this->changeColumn('jonah_tags', 'tag_id', 'integer', array('null' => false, 'autoincrement' => true));
    }
