 ...
 * @author Ralf Lang
 * This includes a lot of copy/paste from Basic.php
 * Original authors:
...
class Passwd_Dynamic
{
    ...
    private function _init()
    {
        ...
        $view->policy  = new Passwd_Policy($this->_backends[$backend_key]['policy']);
        ...
        $page_output->addScriptFile('dynamic.js');
        ...
        $this->_output = $view->render('dynamic');
    }
