...
<input type="hidden" id="passwd-backend" name="backend" value="<?php echo $this->backend ?>" />
<?php endif ?>
...
<?php foreach ($this->policy->description() as $key => $description): ?>
  <tr>
   <td id="<?php echo $key; ?>_policy" class="horde-form-label"><?php echo $description; ?></td>
   <td id="<?php echo $key; ?>_result" class="horde-form-label">&nbsp;</td>
  </tr>
<?php endforeach;?>
<tr>
 <td class="horde-form-label">
...
<tr>
 ...
 <td>
  <select name="backend" id="passwd-backend">
