...
<div id="ansel-contentwrapper">
  <div id="ansel-content" style="background-color:<?php echo $this->background; ?>;">
    ...
    <?php if (!empty($this->urls['delete'])): ?>
      <?php echo $this->contentTag('a', _("Delete"), array('href' => $this->urls['delete'], 'onclick' => 'return window.confirm(\'' . addslashes(sprintf(_("Do you want to permanently delete ''%s''?"), $this->title)) . '\');', 'id' => 'image_delete_link')) ?> |
    <?php endif; ?>
