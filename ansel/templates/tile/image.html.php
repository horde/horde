...
<div class="image-tile" id="imagetile_<?php echo $this->image->id?>">
  <?php echo $this->contentTag('a', $this->tag('img', array('src' => $this->thumb_url, 'alt' => $this->h($this->image->filename))), array_merge(array('title' => $this->image->filename, 'onclick.raw' => $this->imgOnClick), $this->imgAttributes)) ?>
