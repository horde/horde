...
class Ansel_Ajax_Application extends Horde_Core_Ajax_Application
{
    ...
    public function uploadNotification()
    {
        ...
        $gallery = $injector->getInstance('Ansel_Storage')->getGallery($this->_vars->g);
    ...
    public function imageSaveGeotag()
    {
        ...
        $type = $this->_vars->action;
        $location = $this->_vars->location;
        $lat = $this->_vars->lat;
        $lng = $this->_vars->lng;
        $img = $this->_vars->img;
    ...
    public function deleteFaces()
    {
        ...
        $face_id = intval($this->_vars->face_id);
        $image_id = intval($this->_vars->image_id);
    ...
    public function addTag()
    {
        ...
        $gallery = $this->_vars->gallery;
        $tags = $this->_vars->tags;
    ...
    public function embed()
    {
        ...
        $class = 'Ansel_View_EmbeddedRenderer_' . basename($this->_vars->get('gallery_view', 'Mini'));
