...
If you want to upgrade to an alpha or beta version of Turba, you need to tell
...
If you want to upgrade from a Turba version prior to 3.0, please follow the
instructions in INSTALL_ to install the most recent Turba version using the
PEAR installer.
...
Upgrading Turba from 4.2 to 5.0
===============================
...
Upgrading Turba from 4.1 to 4.2
===============================
...
Upgrading Turba from 4.0 to 4.1
===============================
