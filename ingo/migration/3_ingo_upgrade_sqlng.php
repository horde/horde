...
class IngoUpgradeSqlng extends Horde_Db_Migration_Base
{
    ...
    public function up()
    {
        $t = $this->createTable('ingo_sharesng', array('autoincrementKey' => 'share_id'));
        ...
        $t = $this->createTable('ingo_sharesng_groups', array('autoincrementKey' => false));
        ...
        $t = $this->createTable('ingo_sharesng_users', array('autoincrementKey' => false));
        $t->column('share_id', 'integer', array('null' => false));
